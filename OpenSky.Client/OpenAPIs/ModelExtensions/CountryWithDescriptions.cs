// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CountryWithDescriptions.cs" company="OpenSky">
...
#pragma warning disable CS1591
    ...
    /// </remarks>
    /// -------------------------------------------------------------------------------------------------
    public enum CountryWithDescriptions
    {
...
#pragma warning restore CS1591
    ...
    /// </remarks>
    /// -------------------------------------------------------------------------------------------------
    public class CountryComboItem
    {
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        /// Initializes a new instance of the <see cref="CountryComboItem"/> class.
        /// </summary>
        /// <remarks>
        /// sushi.at, 25/07/2021.
        /// </remarks>
        ...
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        /// Gets all country combo items.
        /// </summary>
        /// <remarks>
        /// sushi.at, 25/07/2021.
        /// </remarks>
        /// <returns>
        /// The country combo items.
        /// collection.
        /// </returns>
        /// -------------------------------------------------------------------------------------------------
        public static IEnumerable<CountryComboItem> GetCountryComboItems()
        {
            return (from CountryWithDescriptions category in Enum.GetValues(typeof(CountryWithDescriptions)) select new CountryComboItem(category)).ToList();
        }
