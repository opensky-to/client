// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MyJobs.xaml.cs" company="OpenSky">
...
namespace OpenSky.Client.Pages
{
    ...
    public partial class MyJobs
    {
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        /// Initializes a new instance of the <see cref="MyJobs"/> class.
        /// </summary>
        /// <remarks>
        /// sushi.at, 18/12/2021.
        /// </remarks>
        ...
        /// </param>
        /// -------------------------------------------------------------------------------------------------
        private void MyJobsOnLoaded(object sender, RoutedEventArgs e)
        {
