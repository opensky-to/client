// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PieChartColorConverter.cs" company="OpenSky">
...
namespace OpenSky.Client.Converters
{
    ...
    /// -------------------------------------------------------------------------------------------------
    /// <summary>
    /// Pie/Doughnut adorner label color converter.
    /// </summary>
    /// <remarks>
    /// sushi.at, 02/07/2021.
    /// </remarks>
    ...
    public class PieChartColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                var index = chartAdornment.Series.Adornments.IndexOf(chartAdornment);
                var brush = chartAdornment.Series.ColorModel.GetBrush(index) as SolidColorBrush;
