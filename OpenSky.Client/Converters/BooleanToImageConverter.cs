// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BooleanToImageConverter.cs" company="OpenSky">
...
namespace OpenSky.Client.Converters
{
    ...
    /// -------------------------------------------------------------------------------------------------
    /// <summary>
    /// Boolean to check/redX image converter.
    /// </summary>
    /// <remarks>
    /// sushi.at, 21/02/2022.
    /// </remarks>
    ...
    public class BooleanToImageConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                return boolean ? Application.Current.Resources["Check"] : Application.Current.Resources["Error"];
            }
